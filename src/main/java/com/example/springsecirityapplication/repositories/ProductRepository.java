...
import com.example.springsecirityapplication.models.Category;
...
public interface ProductRepository extends JpaRepository<Product, Integer> {
    ...
    // Поиск по наименованию, фильтрация по диапазону цены, сортировка по возрастанию цены(asc - по убыванию. order by по умолчанию сортирует по возрастанию . значит не надо указывать)
    ...
    // Поиск по наименованию, фильтрация по диапазону цены, сортировка по убыванию цены (desc - по возрастанию)
